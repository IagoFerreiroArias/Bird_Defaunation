...
mu1 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="mu", terms=c("BodyMass_log"), line.size = 2) + theme_bw() + theme(plot.title = element_blank(), axis.title.x = element_blank(),axis.text.x=element_blank(),axis.text.y=element_text(angle=90)) + ylab("Response ratio to hunting pressure") + ylim(-2,2) 
mu2 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="mu", terms=c("DistHunt_log"), line.size = 2) + theme_bw() + theme(plot.title = element_blank(), axis.title.x = element_blank(),axis.title.y = element_blank(), axis.text.y=element_blank(),axis.text.x=element_blank())  + ylim(-2,2)
mu3 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="mu", terms=c("TravDist_log"), line.size = 2) + theme_bw() + theme(plot.title = element_blank(), axis.title.x = element_blank(),axis.title.y = element_blank(), axis.text.y=element_blank(),axis.text.x=element_blank())  + ylim(-2,2)
mu4 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="mu", terms=c("Stunting_log"), line.size = 2) + theme_bw() + theme(plot.title = element_blank(), axis.title.x = element_blank(),axis.title.y = element_blank(), axis.text.y=element_blank(),axis.text.x=element_blank())  + ylim(-2,2)
mu5 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="mu", terms=c("PopDens_log"), line.size = 2) + theme_bw() + theme(plot.title = element_blank(), axis.title.x = element_blank(),axis.title.y = element_blank(), axis.text.y=element_blank(),axis.text.x=element_blank())  + ylim(-2,2)
mu6 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="mu", terms=c("Reserve"), dot.size=5, line.size = 2) + theme_bw() + theme(plot.title = element_blank(), axis.title.x = element_blank(),axis.title.y = element_blank(), axis.text.y=element_blank(),axis.text.x=element_blank())+ ylim(-2,2)
mu7 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="mu", terms=c("Traded"), dot.size=5, line.size = 2) + theme_bw() + theme(plot.title = element_blank(), axis.title.x = element_blank(),axis.title.y = element_blank(), axis.text.y=element_blank(),axis.text.x=element_blank()) + ylim(-2,2)
...
hu1 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="hu", terms=c("BodyMass_log"), line.size = 2) + theme_bw() + theme(plot.title = element_blank(), axis.text.y=element_text(angle=90)) + ylab("Probability of local extirpation") + ylim(0,1) + xlab("Body mass")
hu2 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="hu", terms=c("DistHunt_log"), line.size = 2) + theme_bw() + theme(plot.title = element_blank(),axis.title.y = element_blank(), axis.text.y=element_blank()) + ylim(0,1) + xlab("Distance to hunter's access")
hu3 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="hu", terms=c("TravDist_log"), line.size = 2) + theme_bw() + theme(plot.title = element_blank(),axis.title.y = element_blank(), axis.text.y=element_blank()) + ylim(0,1)  + xlab("Travel time to cities")
hu4 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="hu", terms=c("Stunting_log"), line.size = 2) + theme_bw() + theme(plot.title = element_blank(),axis.title.y = element_blank(), axis.text.y=element_blank())  + ylim(0,1) + xlab("Prevalence of stunting")
hu5 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="hu", terms=c("PopDens_log"), line.size = 2) + theme_bw() + theme(plot.title = element_blank(),axis.title.y = element_blank(), axis.text.y=element_blank())  + ylim(0,1)+ xlab("Human population density")
hu6 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="hu", terms=c("Reserve"), dot.size=5, line.size = 2) + theme_bw() + theme(plot.title = element_blank(), axis.title.y = element_blank(), axis.text.y=element_blank()) + ylim(0,1)
hu7 <- sjPlot::plot_model(hurdle_gam, type="pred",dpar="hu", terms=c("Traded"), dot.size=5, line.size = 2) + theme_bw() + theme(plot.title = element_blank(),axis.title.y = element_blank(), axis.text.y=element_blank())+ ylim(0,1)
hu<-ggarrange(hu1,hu2,hu3,hu4,hu5,hu6,hu7, nrow = 1, ncol=7) 
rm(list=c("hu1","hu2","hu3", "hu4","hu5","hu6","hu7")) #clean environment

m_eff <- ggarrange(mu,hu, ncol=1)

ggsave("Figures/Model/Hurdle_MarginalEffects.pdf", plot=m_eff, width=34, height=13, units="cm")

rm(list=c("mu","hu","m_eff")) #clean environment
